...
resourcename="dogiter1"  # lower case, only
resourcegroup="dogiter1_rg"
...
# git clone https://github.com/apilogicserver/dogiter1.git
# cd dogiter1
...
az group create --name dogiter1_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group dogiter1_rg --sku S1 --is-linux
az container create --resource-group dogiter1_rg --name dogiter1 --image apilogicserver/dogiter1:latest --dns-name-label dogiter1 --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//dogiter1.westus.azurecontainer.io:5656'
