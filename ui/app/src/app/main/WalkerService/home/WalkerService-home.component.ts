...
@Component({
  selector: 'WalkerService-home',
  templateUrl: './WalkerService-home.component.html',
  styleUrls: ['./WalkerService-home.component.scss']
})
export class WalkerServiceHomeComponent implements AfterViewInit {
