...
@Component({
  selector: 'WalkerPackage-home',
  templateUrl: './WalkerPackage-home.component.html',
  styleUrls: ['./WalkerPackage-home.component.scss']
})
export class WalkerPackageHomeComponent implements AfterViewInit {
